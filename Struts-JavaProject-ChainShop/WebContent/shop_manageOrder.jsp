			...
			<s:if test="#singleBO.order_info!='未付款'">
				<div id="singleOrderdiv" style="border: solid 1px; width: 400px;height: 100px;float: left;margin-left: 50px;margin-top: 10px;">
					...
					<div style="border: solid 1px;width: 80px;height:100px;float: left;">
						<dd style="margin-left: 20px"><a href="seller_deliver.action?order_id=${singleBO.order_id}">发货</a></dd>
						<hr class="one_line">
						<dd style="margin-left: 10px"><a href="seller_get_detail_order.action?order_id=${singleBO.order_id}">详细信息</a></dd>
						<hr class="one_line">
					</div>
				</div>
			</s:if>
